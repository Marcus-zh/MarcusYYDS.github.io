setInterval(() => {
  ...
  if ((Number(time[2])<18) && (Number(time[2])>8)){
    currentTimeHtml ="<img class='boardsign' src='https://img.shields.io/badge/Marcus的小窝-学习中-6adea8?style=social&logo=mdBook' title='我要摸鱼!~'><div id='runtime'>" + time[0] + ' YEAR ' + time[1] + ' DAYS ' + time[2] + ' : ' + time[3] + ' : ' + time[4] + '</div>';
  }
  else{
